			...
			<tbody id="load_pagination_menu">
				...
				<tr>
					...
					<ul class="pagination">
						...
						<li class="page-item"><a class="page-link" onclick="cms_pagination_pay({{$i}})" href="#">{{$i}}</a></li>
						@endfor
					</ul>
				</div>
			</div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="{{route('payment.store')}}" method="post" enctype="multipart/form-data" id="form">
								@csrf
						...
						<script>
							...
							function cms_pagination_pay($current_page){
								$param = {
									type:'GET',
									url:'{{route('admin.pagination_pay')}}',
									data:{
